...
def scytale_cipher(message, shift):
    ...
    ##shift will be used as the number of characters per array
    
    ##get the number of arrays
    if messageLen % shift == 0:
        array = int(messageLen / shift)
    else:
        array = int(messageLen / shift) + 1
...
def scytale_decipher(message, shift):
    ...
    # Stay within the function. Only use the parameters as input. The function should return your answer.
    messageLen = len(message)
    ##shift will be used as the number of arrays
    ## ex: shift = 3 it will be distributed to 3 arrays then will be combined
